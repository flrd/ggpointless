...
[`geom_area_fade()`](https://flrd.github.io/ggpointless/reference/geom_area_fade.md)
supports the `orientation` argument familiar from other `geom_*`
functions. With `orientation = "y"`, you create a horizontal area chart
where the gradient fades from `x = 0` toward the data values.
...
![](reference/figures/README-geom-area-fade-global-1.png)
