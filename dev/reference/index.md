...
Drop-in replacements of existing geoms with additional features like
alpha gradients.
...
- [`label_cells()`](https://flrd.github.io/ggpointless/dev/reference/label_cells.md)
...
- [`alpha_scope`](https://flrd.github.io/ggpointless/dev/reference/alpha_scope.md)
