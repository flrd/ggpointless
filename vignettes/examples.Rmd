...
The inspiration to add `geom_lexis()` again came from [Gregor Aisch](https://github.com/gka). This time from his post om [Three decades of European government leaders](https://blog.datawrapper.de/longest-terms-european-leaders/). Unlike in his example, we use data on elected female leaders, that was scapped from the Wikipedia article [List of elected and appointed female heads of state and government](https://en.wikipedia.org/w/index.php?title=List_of_elected_and_appointed_female_heads_of_state_and_government&oldid=1078024588). The dataset `female_leaders` ships with the `ggpointless` package.
