...
Before we plot, a bit of work needs to answer the question: which women are in office for more than 12 years?
...
The inspiration to add `geom_lexis()` came again from [Gregor Aisch](https://github.com/gka). This time from his post on [Three decades of European government leaders](https://blog.datawrapper.de/longest-terms-european-leaders/). Let's see how close we can get with our example to the original.
