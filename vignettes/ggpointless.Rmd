...
`geom_lexis()` draws a lifeline for an event from it's start to it's end. The required aesthetics are `x` and `xend`. Here is an fexample:
...
In order to change the breaks and labels of the y-scale in the left of the previous plots to, say, years, we make the assumption that 1 year has 365.25 days, or 365.25 * 86400 seconds.
