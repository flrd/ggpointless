...
to 2 times the Euclidean distance of all x/y coordinates. You can change this behaviour
when you set `chainLength` argument.
...
If you pick a value that is too short to connect two points, a straight line is drawn
