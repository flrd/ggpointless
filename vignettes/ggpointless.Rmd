...
Each call to `cut_corners()` halves the sharpness of every corner, stepping
from `iterations = 0` (original polygon) towards a near-circular B-spline.
An animated illustration applied to a five-pointed star is available on the
[package website](https://flrd.github.io/ggpointless/articles/ggpointless.html).
