...
## geom_chaikin
`geom_chaikin()` is a function to smooth ragged paths. The algorithm iteratively cut's off sharp corners.
...
p1 <- ggplot(df1, aes(x, y, group = grp)) +
  geom_line(linetype = "12")

p1 +
  geom_chaikin(iterations = 5) # default
p1 +
