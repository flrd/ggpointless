...
The animation below steps through `iterations = 0` (original polygon) to
`iterations = 10` (near-circular B-spline), applied to a five-pointed star:

```{r chaikin-iterations-gif, echo=FALSE, out.width="60%", fig.align="center", fig.cap=""}
