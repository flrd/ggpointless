...
### geom_lexis
`geom_lexis()` is a combination of a segment and a point layer. Given a start and an end, this function draws a 45° line which indicates the duration of an event. Required are `x` and `xend` aesthetics, `y` and `yend` coordinates will be calculated.
...
For more examples see [`vignette("ggpointless")`](https://flrd.github.io/ggpointless/articles/ggpointless.html) and [`vignette("examples")`](https://flrd.github.io/ggpointless/articles/examples.html).
