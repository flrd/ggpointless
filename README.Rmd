...
### geom_lexis
`geom_lexis()` is a combination of a segment and a point layer. Given a start value and an end value, this functions draws a 45° line which indicates the duration of an event.
