...
There are two functions in the `ggpointless` package: `geom_pointless()`, which is powered by `stat_pointless()`. These accept the same arguments like `geom_point()`, with the addition of a `location` argument. You can set it to `"first"`, `"last"` (default), `"minimum"`, `"maximum"`, and `"all"`, where `"all"` is just shorthand to select `"first"`, `"last"`, `"minimum"` and `"maximum"`.
